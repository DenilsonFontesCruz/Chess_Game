...
public class ChessMatch {
	...
	public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition) {
		...
		if(testCheck(currentPlayer)) {
			...
			throw new ChessException("Error: Voce esta em check");
		}
	...
	public ChessPiece replacePromotedPiece(String type) {
		if(promoted == null) {
			throw new IllegalStateException("Error: Nao a peca a ser promovida");
		}
		if(!type.equals("B") && !type.equals("T") && !type.equals("C") && !type.equals("R")) {
			return promoted;
		}
	...
	private void validateSourcePosition(Position position) {
		if (!board.thereIsAPiece(position)) {
			throw new ChessException("Error: Nao existe peca na posicao atual");
		}
		if (currentPlayer != ((ChessPiece)board.piece(position)).getColor()) {
			throw new ChessException("Error: Peca adversaria");
		}
		if (!board.piece(position).isThereAnyPossibleMoves()) {
			throw new ChessException("Error: A peca escolhida nao possui movimentos possiveis");
		}
	}
	...
	private ChessPiece king(Color color) {
		...
		throw new IllegalStateException("Error: Esta faltando o Rei " + color);
	}
